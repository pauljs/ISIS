...
import com.example.isismovingobject.GestureStuff;
 ...
 *
 */
public class movingBitmap implements Runnable {
	...
	public movingBitmap(Bitmap bitmap, int x, int y, int widthOfScreen, int heightOfScreen) {
		this.bitmap = bitmap;
		this.x = x;
		this.y = y;
